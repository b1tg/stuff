  ...
  (let*
    (
      ...
      (coding-system-for-read
       ...
       coding-system-for-read))
  ;;    (a (message "== %s %s" shell-file-name shell-command-switch))
;;      (b (message "==command %s" command))
      (process
        (start-process
          "Shell"
          (generate-new-buffer " *WakaTime messages*")
          ;;shell-file-name
         ;; patch here for fix bug when using Tramp mode
	  "C:/tools/emacs/libexec/emacs/29.2/x86_64-w64-mingw32/cmdproxy.exe"
